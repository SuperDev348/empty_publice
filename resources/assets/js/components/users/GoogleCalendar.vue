            ...
            <div class="form-row">
                <div class="col-12">
                    <div v-if="invalidToken">
                        <div class="">
                            {{$t('lang.cant_connect_google_calender_using_this_credentials')}}
                        </div>
                    </div>
                    <div class="">
                        <div>
                            {{$t('lang.get_your_credentials_from')}}
                            <a href="https://console.developers.google.com" target="_blank">
                                {{$t('lang.google_developers_console')}}
                            </a>
                        </div>
                    </div>
                </div>
                <div class="form-group col-12">
                    <label for="client_id">{{ $t('lang.client_id') }}</label>
                    <input id="client_id"
                           v-validate="'required'"
                           v-model="clientId"
                           type="text"
                ...
                <div class="form-group col-12">
                    <label for="client_secret">{{ $t('lang.client_secret') }}</label>
                ...
                <div class="form-group col-12">
                    <label>{{$t('lang.please_use_this_url_to_create_your_google_app')}}</label>
                    <div>
                        <span class="font-weight-bold">{{ $t('lang.redirect_url') }}</span> : {{redirectUrl}}
                        <span class="ml-2">
                            <a href="#"
                               class="tooltip-copy"
