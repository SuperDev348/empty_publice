        ...
        <nav aria-label="breadcrumb" v-if="profile.is_admin == 1 || profile.role_id > 0 ">
            <ol class="breadcrumb bg-transparent m-0">
                <li class="breadcrumb-item">
                    <span>{{$t('lang.profile_title')}}</span>
                </li>
            </ol>
        </nav>
                ...
                <div class="col-12 col-md-8 col-lg-8 col-xl-9 pr-0">
                    <div class="main-layout-card">
                        <div class="main-layout-card-header">
                            <div class="main-layout-card-content-wrapper">
                                <div class="main-layout-card-header-contents">
                                    <h4 class="m-0" v-if="isActive == 1">{{ $t('lang.profile_title') }}</h4>
                                    <h4 class="m-0" v-if="isActive == 2">{{ $t('lang.change_password') }}</h4>
                                    <h4 class="m-0" v-if="isActive == 3">{{ $t('lang.google_calendar') }}</h4>
                                </div>
                            </div>
                        </div>
