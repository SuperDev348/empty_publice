                ...
                <form class="col s12 sign-in-sign-up-form">
                    ...
                    <div class="row">
                        <div class="input-field col s12" :class="{ 'has-error': errors.email }">
                            ...
                            <label for="email" :class="{'active': errors.email || email.length>0 || checkFocus('#email')}"> {{ $t('lang.login_email') }}</label>
                        ...
                        <div class="input-field col s12" :class="{ 'has-error': errors.password }">
                            ...
                            <label for="password" :data-error="getErrorMessage('password')" :class="{'active': errors.password || password.length>0 || checkFocus('#password')}">{{ $t('lang.login_password') }}</label>
                    ...
                    <div class="row">
                        <div class="col s12 m12 l12">
                            <a href="#" @click="passwordReset" class="bluish-text">{{ $t('lang.forgot_password') }}</a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col s12 m12 l12">
                            <a href="#" @click="redirectHome" class="bluish-text">{{ $t('lang.back_to_home') }}</a>
                        </div>
                    </div>
                </form>
            </div>
