<template>
    <div class="fixed-action-btn horizontal action-com-button">
        ...
        <ul>
            ...
            <li @click.prevent="editField(rowData.id)">
                <a class="btn-floating bluish waves-effect waves-light modal-trigger tooltipped"
                   href="#custom-input-modal" data-position="bottom" data-delay="50" :data-tooltip="$t('lang.edit')">
                    <i class="material-icons white-text icon-vertically-middle">mode_edit</i>
                </a>
            </li>
        </ul>
    </div>
