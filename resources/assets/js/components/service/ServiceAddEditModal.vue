            ...
            <form enctype="multipart/form-data">
                <div class="tab-content service-tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="details">
                        ...
                        <div class="row">
                            <div class="form-group col-12 col-md-6" v-if="businessType == 'general'">
                                <label class="d-block">{{ $t('lang.service_duration_type') }}</label>
                                <div class="form-check-inline">
                                    <label class="form-check-label">
                                        <input type="radio"
                                               class="form-check-input"
                                               :checked="service_duration_type=='hourly'"
                                               @click="setService('hourly')">{{ $t('lang.hourly') }}
                                    </label>
                                </div>
                                <div class="form-check-inline">
                                    <label class="form-check-label">
                                        <input type="radio"
                                               ...
                                               @click="setService('daily')">{{ $t('lang.daily') }}
                                    </label>
                                </div>
                            </div>
                            <div class="form-group col-12 col-md-6">
                                <label class="d-block">{{ $t('lang.multiple_bookings') }}</label>
                                <div class="form-check-inline">
                                    <label class="form-check-label">
                                        <input type="radio"
                                               class="form-check-input"
                        ...
                        <div class="row">
                            <div class="form-group col-md-6" :class="{'col-sm-12': (businessType != 'general')}">
                                <label for="service_starting_date">{{ $t('lang.service_starting_date') }}</label>
                                ...
                                <div v-show="isSubmitted && isServiceStartingDateNotSet"
                                     class="heightError">
                                    <small class="text-danger">
                                        {{ $t('lang.service_starting_date_field_is_required') }}
                                    </small>
                                </div>
                            </div>
                            <div class="form-group col-md-6" :class="{'col-sm-12': (businessType != 'general')}">
                                <label for="service_ending_date">{{ $t('lang.service_ending_date') }}</label>
                                ...
                                <div v-show="isSubmitted && !serviceStartingEndingDateProperlySet"
                                     class="heightError">
                                    <small class="text-danger">
                                        {{ $t('lang.ending_date_should_not_be_before_than_starting_date') }}
                                    </small>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="available_seat">{{ $t('lang.available_seat') }}</label>
                                ...
                                <div v-show="isSubmitted && errors.has('availableSpace')" class="heightError">
                                    <small class="text-danger">
                                        {{$t('lang.available_space_space_field_is_required')}}
                                    </small>
                                </div>
                            </div>
                            <div class="form-group col-lg-6">
                                <label for="price">{{$t('lang.price_per_space') }}</label>
                                <input v-model="price"
                                       name="price"
                                       id="price"
                                       type="text"
                        ...
                        <div v-if="service_duration_type == 'hourly'" class="row">
                            <div class="form-group col-lg-6">
                                <label for="service_starts">{{ $t('lang.service_starts') }}</label>
                                <div>
                                ...
                                <div v-show="isSubmitted && service_starts == timePickerDefaultValueFormat"
                                     class="heightError">
                                    <small class="text-danger">
                                        {{ $t('lang.service_start_field_is_required') }}
                                    </small>
                                </div>
                            </div>
                            <div class="form-group col-lg-6">
                                <label for="service_ends">{{ $t('lang.service_ends') }}</label>
                                <div>
                                ...
                                <div v-show="isSubmitted && service_ends == timePickerDefaultValueFormat"
                                     class="heightError">
                                    <small class="text-danger">
                                        {{ $t('lang.service_end_field_is_required') }}
                                    </small>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="service_duration">{{ $t('lang.service_duration') }}</label>
                                <div>
                                ...
                                <div v-show="isSubmitted && service_duration == '00:00'" class="heightError">
                                    <small class="text-danger">
                                        {{ $t('lang.service_duration_field_is_required') }}
                                    </small>
                                </div>
                                <div v-show="isSubmitted && service_duration != '00:00' && !isStartEndDurationValidate"
                                     class="heightError">
                                    <small class="text-danger">
                                        {{ $t('lang.service_duration_limit_crossed') }}
                                    </small>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                <label for="buffer_time">
                                    {{$t('lang.service_buffering_time')}}
                                </label>
                                <select id="buffer_time" class="custom-select" v-model="buffer_time">
                                    <option value="" selected>{{ $t('lang.choose_one') }}</option>
                                    <option value="00:05:00">5 {{$t('lang.minutes')}}</option>
                                    <option value="00:10:00">10 {{$t('lang.minutes')}}</option>
                                    <option value="00:15:00">15 {{$t('lang.minutes')}}</option>
                                    <option value="00:20:00">20 {{$t('lang.minutes')}}</option>
                                    <option value="00:25:00">25 {{$t('lang.minutes')}}</option>
                                    <option value="00:30:00">30 {{$t('lang.minutes')}}</option>
                                    <option value="00:35:00">35 {{$t('lang.minutes')}}</option>
                                    <option value="00:40:00">40 {{$t('lang.minutes')}}</option>
                                    <option value="00:45:00">45 {{$t('lang.minutes')}}</option>
                                    <option value="00:50:00">50 {{$t('lang.minutes')}}</option>
                                    <option value="00:55:00">55 {{$t('lang.minutes')}}</option>
                                    <option value="01:00:00">1 {{$t('lang.hour')}}</option>
                                    <option value="01:30:00">1.5 {{$t('lang.hours')}}</option>
                                    <option value="02:00:00">2 {{$t('lang.hours')}}</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                <label for="referred_service">
                                    {{$t('lang.share_available_space_with')}}
                                </label>
                    ...
                    <div class="tab-pane fade employee-tab" id="contact">
                        <div class="form-row">
                            <label for="employee">{{ $t('lang.assistant') }}</label>
    ...
    export default {
        ...
        data() {
            return {
                ...
                preloaderType: "",
                hidePreloader: false,
                serviceEndError: this.$t("lang.required_input_field"),
                serviceDurationError: this.$t("lang.required_input_field"),
                serviceDateError: "",
                validDateRange: true,
                customFields: [],
                customFieldsOptions: [],
