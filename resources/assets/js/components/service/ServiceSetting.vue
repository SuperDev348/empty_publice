<template>
    <div>
        <div class="modal-layout-header">
            <div class="row">
                <div class="col-10">
                    <h5 class="bluish-text no-margin">{{ $t('lang.setting_service') }}</h5>
                </div>
                <div class="col-2">
                    <a href="#"
                       class="modal-close"
        ...
        <div class="modal-layout-content" v-show="hidePreloader=='hide'">
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label class="d-block">{{ $t('lang.auto_confirm') }}</label>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="url" :class="{'active':error}">{{ $t('lang.url_alias') }}</label>
                    <input v-model="item.alias"
                           ...
                           @input="disableError">
                    <span class="helper-text" :data-error="$t('lang.required_input_field')"/>
                </div>
                <div class="form-group col-md-6">
            ...
            <div class="row">
                <div class="input-field col s19 m6 l4">
                    ...
                    <label for="max_day_ago" :data-error="$t('lang.required_input_field')">{{
                        $t('lang.allow_booking_max_day_ago') }}</label>
                </div>
                <div class="col s3 m3 l3 no-padding">
                    <div class="days-ago-parent">
                        <small class="grey-text days-ago-child">{{ $t('lang.days_ago')}}</small>
                    </div>
                </div>
                <div class="col s12">
                    ...
                    <button class="btn cancel-btn waves-effect waves-grey mob-btn modal-close"
                            @click.prevent="setActive(1,'')">{{ $t('lang.cancel') }}
                    </button>
                </div>
            </div>
        </div>
