    ...
    <div>
        ...
        <div class="modal-layout-content" v-else>
            <form>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="alias">{{ $t('lang.url_alias') }}</label>
                        <input v-model="alias"
                               v-validate="'required'"
                               name="alias"
                               id="alias"
                    ...
                    <div class="form-group col-md-6">
                        <label for="allow_booking_max_day_ago">
                            {{ $t('lang.allow_booking_max_day_ago') }}
                        </label>
                ...
                <div v-if="business_type=='salon'">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label class="d-block">{{$t('lang.consider_children_for_price') }}</label>
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio"
                                           class="form-check-input"
