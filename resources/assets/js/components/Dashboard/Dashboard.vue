                    ...
                    <div class="card-content">
                        <div class="dashboard-card-parent">
                            ...
                            <div class="dashboard-card-child-2">
                                ...
                                <p>
                                    {{ $t('lang.total_booking_for_next_30_days') }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-content">
                        <div class="dashboard-card-parent">
                            ...
                            <div class="dashboard-card-child-2">
                                <h5>{{totalBooking}}</h5>
                                <p>
                                    {{ $t('lang.confirmed_booking_for_next_30_days') }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="main-layout-card-header-with-button">
                        <div class="main-layout-card-content-wrapper">
                            <div class="main-layout-card-header-contents">
                                <h5 class="no-margin">{{ $t('lang.booking_overview') }}</h5>
                                <small class="grey-text">{{ $t('lang.last_12_months') }}</small>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div class="main-layout-card">
                    <div class="main-layout-card-header-with-button">
                        <div class="main-layout-card-content-wrapper">
                            <div class="main-layout-card-header-contents">
                                <h5 class="no-margin">{{ $t('lang.booking_type') }}</h5>
                                <small class="grey-text">{{ $t('lang.total_bookings_of_different_services') }}
                                </small>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card dashboard-card-bottom">
                    <div class="card-content cyan">
                        <div class="text-white">
                            <h5>{{ $t('lang.this_Month') }}</h5>
                            <h6>{{ $t('lang.total_booking') }}</h6>
