                    ...
                    <div class="card-content">
                        <div class="dashboard-card-parent">
                            ...
                            <div class="dashboard-card-child-2">
                                ...
                                <small class="">{{ $t('lang.total_booking') }}</small>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-content">
                        <div class="dashboard-card-parent">
                            ...
                            <div class="dashboard-card-child-2">
                                ...
                                <small class="">{{ $t('lang.booking_pending') }}</small>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-content">
                        <div class="dashboard-card-parent">
                            ...
                            <div class="dashboard-card-child-2">
                                ...
                                <small class="">{{ $t('lang.booking_confirm') }}</small>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-content">
                        <div class="dashboard-card-parent">
                            ...
                            <div class="dashboard-card-child-2">
                                ...
                                <small class="">{{ $t('lang.booking_cancel') }}</small>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="main-layout-card-header-with-button">
                        <div class="main-layout-card-content-wrapper">
                            <div class="main-layout-card-header-contents">
                                <h5 class="no-margin">{{ $t('lang.booking') }}</h5>
                            </div>
                        </div>
                    </div>
