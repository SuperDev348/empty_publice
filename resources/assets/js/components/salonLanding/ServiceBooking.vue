<template>
    <div>
            ...
            <div class="loader" v-if="!hidePreLoader">
        ...
        <div class="service-book-area" v-else >
            ...
            <!--Service list area-->
            <div id="service"  class="service-list-area">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-5">
                                ...
                                <p class="subtitle">{{ $t('lang.service_subtitle') }}</p>
                            </div>
                        </div>
                    </div>

                    <div class="row">
                        <div class="col-sm-4 col-md-4 wow slideInUp animated" data-wow-duration="1.00s" data-wow-delay="0s" style="visibility: visible; animation-duration: 1s; animation-delay: 0s; animation-name: slideInUp;" v-for="serviceData in serviceListData">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title text-truncate mb-4">{{ serviceData.title }}</h5>
                                       <div class="mb-3">
                                                <p class="text-with-opacity">{{ serviceData.description }}</p>
                                            </div>
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="media mb-3">
                                                ...
                                                <div class="media-body">
                                                    <p class="service-info-heading">{{ $t('lang.duration')}}:</p>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-5">
                                ...
                                <p class="subtitle">{{ $t('lang.you_can_book_service_easily') }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
<!--calander modal-->
        ...
        <div class="modal modal-landing fade" id="calander-modal" tabindex="-1" role="dialog"
                                                        ...
                                                        <div class=""
                                                            ...
                                                            <a href="#"
                                                               ...
                                                               @click.prevent="handleDateTime(serviceTime, index)">
                                                                ...
                                                                <span v-show="noOfAdult + noOfChildren > availableSeatsForTiming[index] || availableSeatsForTiming[index] == 0"> -{{$t('lang.available')}}:{{ availableSeatsForTiming[index] }}</span>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-12 col-sm-12 col-md-8 col-lg-8">
                                            <div class="service-information-wrapper">
                                                ...
                                                <div class="mb-3">
                                                    <div class="mb-0">
                                                        <span class="service-info-heading">{{ $t('lang.salon_book_date') }}: </span>
                                                        ...
                                                        <a href="#"
                                                           ...
                                                           @click.prevent="reSetDateTime">
                                                            <i class="las la-calendar"/> {{ $t('lang.change') }}
                                                        </a>
                                                    </div>
                                                    <p class="mb-0">
                                                        <span class="service-info-heading">{{ $t('lang.time') }}: </span>
                                                    ...
                                                    <p class="mb-0">
                                                        <span class="service-info-heading">{{ $t('lang.no_of_guest') }}: </span>
                                                        <span class="service-info-value">{{ noOfAdult }} {{ $t('lang.adults')}} - {{ noOfChildren }} {{ $t('lang.children')}}</span>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-body justify-content-center">
                        <h4 class="modal-title text-center mb-4">{{$t('lang.congratulations') }}</h4>
                        <div class="text-center thank-you-icon">
                            <i class="las la-check la-4x mb-4 animated rotateIn"/>
                        </div>
                        <h5 class="text-center mb-4">
                            {{$t('lang.successful_service_booked_message') }}
                        </h5>
                        <div class="row justify-content-center">
                            <div class="col-6 col-sm-4 col-md-4 col-lg-4 col-xl-4">
                                <button type="button"
        ...
        <!-- choose payment ways   Insurance | Credit Card  , Select Worker -->
        <div class="modal modal-landing fade" id="payment-method-modal" tabindex="-1" role="dialog"
             aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div v-else class="modal-body justify-content-center">
                        <h4 class="mb-4 text-center">
                            ...
                            <span class="text-payment-confirm">
                                 {{$t('lang.chooseworkerpayway')}} 
                            </span>
                        </h4>                        
                    </div>   
                    <div class="payments-button-wrapper" style="margin-bottom:50px">
                        <div class="row">
                            <div class="col-6 offset-3">
                                <select class="form-control" id="select-worker"
                                    style="
                                        height: 50px;
                                        border-radius: 50px;
                                        font-size: 0.9rem;
                                    ...
                                    >
                                    <option value="0">{{$t('lang.chooseworker')}} </option>
                                    <option v-for="worker in workers" :key="worker.id" :value="worker.id" >{{worker.first_name + ' ' + worker.last_name}}</option>                                  
                                </select>
                            </div>
                        </div>
                    </div>
                    <div class="payments-button-wrapper" style="margin-bottom:50px">
                        <div class="row">
                            <div class="col-3 offset-3">
                                <a href="#" class="btn payment-methods-btn btn-sm" style="border-radius: 50px">{{$t('lang.insurancepayway')}}  </a>
                            </div>
                            <div class="col-3">
                                <a href="#" class="btn payment-methods-btn btn-sm" style="border-radius: 50px" @click.prevent="checkCreditCardConfirm"> {{$t('lang.creditcardpayway')}}  </a>
                            </div>
                        </div>
                    </div>                
                </div>
        ...
        <div class="modal fade" id="authentication-warning-modal" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content px-4 pb-4 pt-3 text-center">
                    ...
                    <h5>{{ $t('lang.you_cant_book') }}</h5>
                    <h6>{{ $t('lang.please_login_and_try_again') }}</h6>
                    <div class="my-4">
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                locales: allLocales,
                locale: this.$t('lang.calender_language_set'),
        ...
        created() {
            ...
            this.getServiceData('/getAllServiceFormDataByVendor/'+this.vid);
        ...
        methods: {
            getServiceWorkers(route) {
                let instance = this;
                this.axiosGet(
                    route,
                    function (response) {
                        instance.workers = response.data.workers;
                            ...
                            if (instance.selectService.multiple_bookings == 0) {
                                setTimeout(function () {
                                    $('.tooltip-guest-adult').tooltip('dispose').tooltip(
                                        {
                                            title: instance.$t('lang.tooltip_guest_selection_alert_without_multi_booking')
                                        }
                                    ).tooltip('show');
                                }, 100);
                            } else {
                                setTimeout(function () {
                                    $('.tooltip-guest-adult').tooltip('dispose').tooltip(
                                        {
                                            title: instance.$t('lang.tooltip_guest_selection_alert')
                                        }
                                    ).tooltip('show');
                                }, 100);
                            }
                ...
                instance.$validator.validateAll().then((result) => {
                    ...
                    if (result && instance.eitherEmailOrPhoneValidation()) {
                        ...
                        instance.inputFields = {
                            ...
                            selectedWorker: instance.selectedWorkerId,
                        };

                        console.log(instance.inputFields);
            ...
            checkConfirm() {          
                let instance = this;        
                this.getServiceWorkers('/get-service-workers/'+this.vid+'/'+instance.service_id);     
                $('#payment-method-modal').modal('show');
                //instance.save();
            },
            checkCreditCardConfirm() {
                let instance = this;
                if (!instance.checkPaymentMethod(instance.paymentMethods)) {
                    instance.$validator.validateAll().then((result) => {
                        if (result) {                            
                            if (instance.selectedWorkerId != 0) {
                            $('#payment-method-modal').modal('hide');
                            //console.log(instance.selectedWorkerId);
