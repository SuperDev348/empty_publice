        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent m-0">
                <li class="breadcrumb-item">
                    <span>{{ $t('lang.booking_details') }}</span>
                </li>
            </ol>
        </nav>
        <div class="">
                        ...
                        <div class="main-layout-card-header">
                            <div class="main-layout-card-content-wrapper">
                                <div class="main-layout-card-header-contents">
                                    <h5 class="">
                                        {{ $t('lang.booking_details') + ' #'+ bookingDetails.id }}
                                    </h5>
                                </div>
                        ...
                        <div class="main-layout-card-content">
                            ...
                            <div v-else>
                                ...
                                <div class="booking-details-view" v-else>
                                    <span class="booking-status red">{{ $t('lang.due') }}</span>
                                </div>
                                ...
                                <div class="booking-details-view">
                                    {{ localTime(bookingDetails.created_at) }}
                                </div>
