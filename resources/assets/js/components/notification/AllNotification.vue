            ...
            <div class="main-layout-card-header">
                <div class="main-layout-card-content-wrapper">
                    <div class="main-layout-card-header-contents">
                        <h5 class="mb-0">{{ $t('lang.your_notifications') }}</h5>
                    </div>
                </div>
            </div>
            <div class="main-layout-card-content all-notification-wrapper">
                <div class="media"
                    ...
                    <div class="media-body">
                        <p class="mb-0">{{ notification.first_name+" "+notification.last_name+" "+$t('lang.'+notification.event)+" #"+notification.booking_id}}</p>
                        <p class="mb-0 small">{{ $t('lang.received_at') }} : {{ localTime(notification.created_at)}}</p>
                    </div>
                </div>
                <div v-if="notifications.length == 0">
                    {{ $t('lang.you_have_no_notifications') }}
                </div>
            </div>
        </div>
    </div>
