                            ...
                            <form class="sign-in-sign-up-form">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-12">
                                        ...
                                        <label class="text-center d-block">{{ $t('lang.sign_up_for_your_new_account')
                                            }}</label>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-12">
                                        ...
                                        <input id="first_name"
                                               ...
                                               type="text"
                                               v-model="first_name"
                                               :data-vv-as="$t('lang.first_name_small')"
                                               name="first_name"
                                               :placeholder="$t('lang.enter_first_name')"
                                               class="form-control">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-12">
                                        ...
                                        <input id="last_name"
                                               ...
                                               type="text"
                                               v-model="last_name"
                                               :data-vv-as="$t('lang.last_name_small')"
                                               name="last_name"
                                               :placeholder="$t('lang.enter_last_name')"
                                               class="form-control">
                                        <div class="heightError">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-12">
                                        <label for="email">{{ $t('lang.phone') }}</label>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-12">
                                        <label for="password">{{ $t('lang.login_password') }}</label>
                                        <input id="password"
                                               ref="password"
                                               v-validate="'required'"
                                               v-model="password"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-12">
                                        <label for="conf-password">{{ $t('lang.confirm_password') }}</label>
                                        <input id="conf-password"
                                               v-model="password_confirmation"
                                               v-validate="'required|confirmed:password'"
                                               :data-vv-as="$t('lang.confirm_password_small')"
            ...
            getSmsSettingStatus(route){
                ...
                instance.axiosGet(route,
                    function (response) {
                        ...
                        console.log(instance.isSmsSettingSet,"instance.isSmsSettingSet");
                    },
                    function (errror) {
