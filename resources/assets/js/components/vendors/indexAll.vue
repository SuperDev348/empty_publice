    ...
    <div class="main-layout-wrapper">
        ...
        <div class="modal fade" id="add-edit-modal" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered big-modal-dialog" role="document">
                <createvendors-form class="modal-content"
                                    v-if="isActive"
                                    :id="selectedItemId"
                                    :modalID="modalID"/>
            </div>
        ...
        data() {
            ...
            return {
                ...
                tableOptions: {
                    tableName: 'vendors',
                    columns: [
                        {title: 'lang.name', key: 'name', type: 'text', uniquefield: 'id', sortable: true},
                        {title: 'lang.address', key: 'address', type: 'text', sortable: true},
                        {title: 'lang.phone', key: 'phone', type: 'text', sortable: true},
                        {title: 'lang.categories', key: 'category', type: 'text', sortable: true},
