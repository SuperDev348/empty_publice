...
<script>
    ...
    export default {
        ...
        props: ['message', 'firstButtonName', 'secondButtonName'],
        methods: {
            buttonAction() {
                this.$emit('disableEnableUserAction');
            }
        }
    }
</script>
