    ...
    <div class="main-layout-card">
        <div class="main-layout-card-header">
            <div class="main-layout-card-content-wrapper">
                <div class="main-layout-card-header-contents">
                    <h5 class="bluish-text no-margin">{{ $t('lang.contact_information') }}</h5>
                </div>
            </div>
        </div>
        ...
        <div class="main-layout-card-content" v-else>
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    <label for="sub_title">{{$t('lang.address') }}</label>
                ...
                <div class="form-group col-md-6">
                    <label for="title">{{$t('lang.phone') }}</label>
