        ...
        <div class="main-layout-card-header">
            <div class="main-layout-card-content-wrapper">
                <div class="main-layout-card-header-contents">
                    <h5 class="bluish-text m-0">{{ $t('lang.social_links') }}</h5>
                </div>
            </div>
        </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="facebook">{{ $t('lang.facebook') }}</label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="instagram">{{ $t('lang.instagram') }}</label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="linkedin">{{ $t('lang.linkedin') }}</label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="twitter">{{ $t('lang.twitter') }}</label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="google_plus">{{ $t('lang.google_plus') }}</label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="youtube">{{ $t('lang.youtube') }}</label>
                            <input type="text" class="form-control" id="youtube" name="youtube" v-model="item.youtube">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="pinterest">{{ $t('lang.pinterest') }}</label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="tumblr">{{ $t('lang.tumblr') }}</label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="flickr">{{ $t('lang.flickr') }}</label>
