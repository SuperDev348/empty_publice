    ...
    <div>
        <div class="modal-layout-header">
            <div class="container-fluid p-0">
                <div class="row">
                    <div class="col-10">
                        <h4 class="m-0" v-if="id">{{ $t('lang.edit_holiday') }}</h4>
                        <h4 class="m-0" v-else>{{ $t('lang.add_holiday') }}</h4>
                    </div>
        ...
        <div class="modal-layout-content" v-else>
            <form class="form-row">
                ...
                <div class="form-group col-md-12">
                    <label class="" for="start_date">{{ $t('lang.start_date') }}</label>
                    <datepicker
                ...
                <div class="form-group col-md-12">
                    <label class="">{{ $t('lang.end_date') }}</label>
    ...
    export default {
        ...
        data() {
            return {
                ...
                dateEndError: this.$t('lang.required_input_field'),
            }
        },
        created() {
            if (this.id) {
