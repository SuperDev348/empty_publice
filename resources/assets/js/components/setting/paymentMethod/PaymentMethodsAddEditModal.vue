    ...
    <div>
        <div class="modal-layout-header">
            <div class="container-fluid p-0">
                <div class="row">
                    <div class="col-10">
                        <h4 class="m-0" v-if="id">{{ $t('lang.edit_payment_method') }}</h4>
                        <h4 class="m-0" v-else>{{ $t('lang.add_payment_method') }}</h4>
                    </div>
            ...
            <form v-else>
                <div class="form-row">
                    ...
                    <div class="form-group col-md-12">
                        <label for="type-name">{{ $t('lang.name') }}</label>
                    ...
                    <div class="form-group col-12">
                        <label class="d-block" for="type-name">{{ $t('lang.status') }}</label>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="enable" id="enable" value="1"
                                   v-model="status">
                            <label class="form-check-label" for="enable">{{ $t('lang.enable') }}</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="disable" id="disable" value="0"
                                   v-model="status">
                            <label class="form-check-label" for="disable">{{ $t('lang.disable') }}</label>
                        </div>
                    </div>
                    <div class="form-group col-12">
                        <label class="d-block" for="type-name">{{ $t('lang.available_to_client') }}</label>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="yes" id="yes" value="1"
                                   v-model="available_to_client">
                            <label class="form-check-label" for="yes">{{ $t('lang.yes') }}</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="no" id="no" value="0"
                                   v-model="available_to_client">
                            <label class="form-check-label" for="no">{{ $t('lang.no') }}</label>
                        </div>
                    </div>
                </div>
                <div class="form-row" v-if="type === 'paypal' || type === 'stripe'">
                    <div class="form-group col-12" v-if="type === 'stripe'">
                        <label for="type-name">{{ $t('lang.publishablekey') }}</label>
                    ...
                    <div class="form-group col-12" v-if="type=='paypal'">
                        <label for="type-name">{{ $t('lang.client_id') }}</label>
                    ...
                    <div class="form-group col-12">
                        <label for="type-name">{{ $t('lang.secret_key') }}</label>
                    ...
                    <div class="form-group col-12" v-if="type=='paypal'">
                        <label class="d-block" for="type-name">{{ $t('lang.mode') }}</label>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="live" id="live" value="1"
                                   v-model="mode_paypal">
                            <label class="form-check-label" for="live">{{ $t('lang.live') }}</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="sandbox" id="sandbox" value="0"
                                   v-model="mode_paypal">
                            <label class="form-check-label" for="sandbox">{{ $t('lang.sandbox') }}</label>
                        </div>
                    </div>
                </div>
                <div class="form-row">
