    ...
    <div>
        ...
        <div class="modal-layout-content" v-else>
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    <label for="field-type">{{$t('lang.select_service') }}</label>
                    ...
                    <small class="text">
                        {{ $t('lang.select_service_custom_field')}}
                    </small>
                </div>
                ...
                <div class="form-group col-md-12">
                    ...
                    <div class="custom-control custom-checkbox">
                        <input class="custom-control-input" type="checkbox" id="3" v-model="visibleToClient"
                               ...
                               value="1">
                        <label class="custom-control-label" for="3">{{ $t('lang.visible_to_client') }}</label>
                    </div>
                </div>
