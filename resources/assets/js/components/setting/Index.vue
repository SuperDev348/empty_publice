                            ...
                            <div class="main-layout-card-header">
                                <div class="main-layout-card-content-wrapper">
                                    <div class="main-layout-card-header-contents">
                                        <h5 class="bluish-text m-0">{{ $t('lang.settings') }}</h5>
                                    </div>
                                </div>
                            </div>
                            <div>
...
<script>
    export default {
    props: ['all_time_zone', 'service_policy', 'app_settings', 'email_settings', 'email_templates', 'sms_settings', 'sms_templates', 'off_day', 'vendor_profile', 'holiday', 'roles', 'users','categories', 'client_settings', 'payment_settings', 'custom_input_settings', 'social_link', 'contact_information', 'updates', 'break_time'],
        data() {
            return {
                selectedTab: null,
                componentName: null,
                tabs: [
                    ...
                    {name: "vendor_profile", lang: "lang.profile_title", component: "vendor-profile-setting"},
                    ...
                    {name: "categories", lang: "lang.categories", component: "categories"},
