        ...
        <div class="main-layout-card-header">
            <div class="main-layout-card-content-wrapper">
                <div class="main-layout-card-header-contents">
                    <h5 class="bluish-text m-0">{{ $t('lang.sms_settings') }}</h5>
                </div>
            </div>
        </div>
            ...
            <form v-else>
                <div class="form-row">
                    <div class="form-group col-md-5">
                        <label for="from_name_phone">{{ $t('lang.sms_send_from_name_phone_number') }}</label>
                        <input
                                type="text"
                        ...
                        <div class="heightError">
                            ...
                            >{{ errors.first('sms_send_from_name_phone_number') }}</small>
                        </div>
                    </div>

                    <div class="form-group offset-md-1 col-md-5">
                        <label for="sms-driver">{{ $t('lang.sms_driver') }}</label>
                        <select id="sms-driver"
                            ...
                            <option value disabled selected>{{ $t('lang.choose_one') }}</option>
                                <option value="nexmo">{{ $t('lang.nexmo') }}</option>
                        </select>
                    ...
                    <div class="form-group col-md-5" v-show="smsDriver === 'nexmo' ">
                        <label for="key">{{ $t('lang.key') }}</label>
                        <input
                                type="text"
                                name="key"
                    ...
                    <div class="form-group offset-md-1 col-md-5" v-show="smsDriver === 'nexmo'">
                        <label for="secret_key">{{ $t('lang.secret_key') }}</label>
                        <input
                                type="text"
                                name="secret_key"
                                v-validate="{required:isNexmoActive}"
