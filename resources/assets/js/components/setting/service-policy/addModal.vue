<template>
    <div>
        <div class="modal-header">
            <h4 class="modal-title">{{ $t('lang.service_policy') }}</h4>
                ...
                <div class="form-group col-md-4">
                    ...
                    <div class="form-check">
                        ...
                        <input class="form-check-input" type="radio" v-model="consider_children_for_price"
                               ...
                               :class="{ 'is-invalid': submitted && errors.has('consider_children_for_price') }"
                               value="no">
                        <label for="childen_for_price_no" class="radio-button-label">{{$t('lang.no') }}</label>
                    </div>
                    <div class="heightError">
        ...
        <div class="modal-footer">
            <button class="btn btn-primary app-color" @click.prevent="inviteUser()" type="submit">{{$t('lang.save')
                }}
            </button>
        </div>
    </div>
