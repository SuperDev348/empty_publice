            ...
            <form v-else>
                <div class="mb-4">
                    <h6 class="app-heading-color">
                        {{ $t('lang.general_settings') }}
                    </h6>

                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="appname">{{ $t('lang.app_name') }}</label>
                            <input type="text" class="form-control" id="appname" v-model="item.app_name">
                        </div>
                        <div class="form-group col-md-6">
                            <label>{{ $t('lang.change_app_logo') }}</label>
                            <div class="custom-file">
                                ...
                                <label class="custom-file-label text-truncate" for="app-logo">
                                    {{ $t('lang.placeholder_choose_app_logo') }}
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="rows-per-table">{{ $t('lang.rows_per_table') }}</label>
                            <select id="rows-per-table" v-model="item.max_row_per_table" class="custom-select">
                                <option disabled selected>{{ $t('lang.choose_one') }}</option>
                        ...
                        <div class="form-group col-md-6">
                            <label>{{ $t('lang.change_background_image') }}</label>
                            <div class="custom-file">
                                <input type="file"
                                       class="custom-file-input"
                                       id="background-image"
                                ...
                                <label class="custom-file-label text-truncate" for="background-image">
                                    {{ $t('lang.placeholder_choose_background_image') }}
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <!--<div class="row">
                        <div class="form-group col-md-6">
                            <label for="business_type">{{ $t('lang.business_type_setting') }}</label>
                            <select id="business_type" v-model="item.business_type" class="custom-select">
                                <option disabled selected>{{ $t('lang.choose_business_type') }}</option>
                ...
                <div class="mb-4">
                    <h6 class="app-heading-color">
                        {{ $t('lang.landing_page_settings') }}
                    </h6>
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="landing_page_header">{{ $t('lang.landing_page_header') }}</label>
                            <input type="text"
                        ...
                        <div class="form-group  col-md-6">
                            <label for="landing_page_message">
                                {{ $t('lang.landing_page_message') }}
                                <span class="text-secondary font-italic">{{ $t('lang.max_landing_page_message') }}</span>
                            </label>
                ...
                <div class="mb-4">
                    <h6 class="app-heading-color">
                        {{ $t('lang.time_and_date_settings') }}
                    </h6>

                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="time_zone">{{ $t('lang.time_zone') }}</label>
                        ...
                        <div class="form-group col-md-6">
                            <label for="dateformat">{{ $t('lang.date-format') }}</label>
                            <select id="dateformat" v-model="item.date_format" class="custom-select">
                                <option value="" disabled>{{ $t('lang.choose_one') }}</option>
                                <option value="d/m/Y">{{ $t('lang.dd/mm/yyyy') }}</option>
                                <option value="m/d/Y">{{ $t('lang.mm/dd/yyyy') }}</option>
                                <option value="Y/m/d">{{ $t('lang.yyyy/mm/dd') }}</option>
                                <option value="d-m-Y">{{ $t('lang.dd-mm-yyyy') }}</option>
                                <option value="m-d-Y">{{ $t('lang.mm-dd-yyyy') }}</option>
                                <option value="Y-m-d">{{ $t('lang.yyyy-mm-dd') }}</option>
                                <option value="d.m.Y">{{ $t('lang.dd_mm_yyyy') }}</option>
                                <option value="m.d.Y">{{ $t('lang.mm_dd_yyyy') }}</option>
                                <option value="Y.m.d">{{ $t('lang.yyyy_mm_dd') }}</option>
                            </select>
                        </div>
                        <div class="form-group col-md-6">
                            <label class="d-block"> {{ $t('lang.time_format') }}</label>
                ...
                <div class="mb-4">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="language">{{ $t('lang.preferred_language') }}</label>
                ...
                <div class="mb-4">
                    <h6 class="app-heading-color">
                        {{ $t('lang.currency_settings') }}
                    </h6>
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="currency-symbol">{{ $t('lang.currency_symbol') }}</label>
                            <input type="text"
                                   class="form-control"
                                   id="currency-symbol"
                        ...
                        <div class="form-group col-md-6">
                            <label for="currency-position">{{ $t('lang.currency_position') }}</label>
                        ...
                        <div class="form-group col-md-6">
                            <label for="currency_code">{{ $t('lang.currency_code') }}
                                <i class="la la-info-circle setting-info-icon"
                                   data-toggle="tooltip"
                                   data-placement="top"
                                   :title="$t('lang.please_use_valid_currency_code')"
                                   :data-original-title="$t('lang.please_use_valid_currency_code')"
                                   rel="tooltip"/>
                            </label>
                            <input type="text"
                                   id="currency_code"
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="decimal-separator">{{ $t('lang.decimal_separator') }}</label>
                        ...
                        <div class="form-group col-md-6">
                            <label for="thousand-separator">{{ $t('lang.thousand_separator') }}</label>
                        ...
                        <div class="form-group col-md-6">
                            <label class="d-block">{{ $t('lang.number_of_decimal') }}</label>
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio"
                                           class="form-check-input"
                ...
                <div class="mb-4">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="company_name">{{ $t('lang.company_name') }}</label>
                            <input type="text"
                                   class="form-control"
                                   id="company_name"
                        ...
                        <div class="form-group col-md-6">
                            <label>{{ $t('lang.change_invoice_logo') }}</label>
                            <div class="custom-file">
                                <input type="file"
                                       class="custom-file-input"
                                       id="invoice-logo"
