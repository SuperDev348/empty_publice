...
//vendors-------------------------------------------------------------------------------------
Vue.component('vendors-index', require('./components/vendors/indexAll.vue'));
Vue.component('createvendors-form', require('./components/vendors/VendorsAddEditModal.vue'));
Vue.component('vendor-action-component', require('./components/datatable/VendorsTableActions.vue'));


Vue.component('categories', require('./components/setting/vendorCategory/Index.vue'));  
Vue.component('createcategories-form', require('./components/setting/vendorCategory/categoryAddEditModal.vue'));


//products
Vue.component('products-index', require('./components/products/indexAll.vue'));
Vue.component('createproducts-form', require('./components/products/ProductsAddEditModal.vue'));

 
//products-order
Vue.component('products-order-index', require('./components/products-order/indexAll.vue'));
Vue.component('orders-action-component', require('./components/datatable/OrdersTableActions.vue'));

//lang
Vue.component('LocaleSwitcher', require('./components/include/LocaleSwitcher.vue'));

//vendor profile
Vue.component('vendor-profile-setting', require('./components/setting/vendorProfile/vendorProfileSetting.vue'));

Vue.component('banners-index', require('./components/banners/indexAll.vue'));
Vue.component('createbanners-form', require('./components/banners/bannerAddEditModal.vue'));
Vue.component('Edit-Delete-action-component', require('./components/datatable/Edite_Delete_TableActions.vue'));
...
Vue.component('salon_home_component', require('./components/salonLanding/Salonhome.vue'));
Vue.component('service_booking_landing', require('./components/salonLanding/ServiceBooking.vue'));
Vue.component('service_category_landing', require('./components/salonLanding/ServiceCategory.vue'));
Vue.component('order_products_landing', require('./components/salonLanding/OrderProduct.vue'));
...
//Workers
Vue.component('worker-index', require('./components/worker/indexAll.vue'));
Vue.component('createworker-form', require('./components/worker/WorkerAddEditModal.vue'));
Vue.component('worker-setting-modal', require('./components/worker/WorkerSettingModal.vue'));
...
Vue.component('user-list-vendor', require('./components/datatable/UserVendorList.vue')); //User role check;
...
Vue.component('worker-action-component', require('./components/datatable/WorkerTableActions.vue'));
...
Window.app = new Vue({
    ...
    created(){
        this.$i18n.locale = this.getLangFromStorage()
    }
});
