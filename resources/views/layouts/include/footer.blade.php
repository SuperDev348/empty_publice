...
<?php
    ...
    $scriptSources=[
        ...
        [
            'comment' =>'<!--choices-->',
            'src' => asset($publicPath.'/js/choices.js'),
        ],
	 
		// [
		// 	'comment' =>'<!--jquery-->',
		// 	'src' => asset($publicPath.'/js/jquery.min.js'),
		// ],
		[
			'comment' =>'<!--wow-->',
			'src' => asset($publicPath.'/js/wow.min.js'),
		],
        [
            'comment' =>'<!--slick.min-->',
            'src' => asset($publicPath.'/js/slick.min.js'),
        ],
        [
            'comment' =>'<!--custom.min-->',
            'src' => asset($publicPath.'/js/custom.js'),
        ],
    ];
