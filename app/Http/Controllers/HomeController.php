...
{
    //addes by younis for first page
    public function homePage1($serviceAlias = '')
    {
        ...
        if ($installCheck == true) {
            ...
            $banner=banners::where('activation', '1')->select('*')->get();;
    ...
    public function homePage($id,$serviceAlias = '')
    {
        $installCheck = config('gain.installed');
