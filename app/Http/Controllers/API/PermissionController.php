...
class PermissionController extends Controller
{
    ...
    public function vendorManagePermission()
    {
         if ($this->permissionCheck()->hasPermission('can_manage_vendors') || $this->permissionCheck()->isAdmin()) {
            error_log($this->permissionCheck()->hasPermission('can_manage_vendors'));
            return 1;
    ...
    public function workerManagePermission()
    {
         if ($this->permissionCheck()->hasPermission('can_manage_workers') || $this->permissionCheck()->isAdmin()) {
            error_log($this->permissionCheck()->hasPermission('can_manage_workers'));
            return 1;
